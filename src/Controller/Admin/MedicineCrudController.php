...
class MedicineCrudController extends AbstractCrudController
{
    ...
    {
        return [
            NumberField::new('code_CIS', "Le code CIS du médicament")
                ->setHelp("Le code CIS ou Code Identifiant de Spécialité est un code numérique de 8 chiffres qui permet d'identifier un médicament quelle que soit sa présentation (ou encore conditionnement)."),
            TextField::new('name', 'Nom du médicament')
                ->setHelp("Le nom commun du médicament référencé."),
            ...
            TextField::new('medic_type', 'Type du médicament')
            ...
            TextEditorField::new('medic_condition', 'Indications thérapeutiques')
                ->setHelp("L'indication thérapeutique renseigne sur la maladie ou les symptômes que le médicament est capable de traiter ou de prévenir, ou encore sur le diagnostic qu'il permet d'établir."),
            TextEditorField::new('medic_dosage',  'Posologie recommandée')
                ->setHelp("Indication de la dose et du rythme de prise du médicament notamment déterminé selon l'âge, le sexe, le poids et l'état clinique du patient."),
            TextEditorField::new('medic_exeption', 'Autre(s) situation(s) clinique(s)')
                ->setHelp("Les autres situations cliniques sont des situations, dans lesquelles la posologie du médicament est différente qu'initialement."),
            TextEditorField::new('medic_method_administration', 'Mode d\'administration')
                ->setHelp("Le mode d'administration est la voie par laquelle le médicament est pris, avec une recommandation éventuelle."),
            TextEditorField::new('medic_danger', 'Contre-indication(s)')
                ->setHelp("Situation dans laquelle on ne doit pas donner le médicament pour des raisons de sécurité. Cette situation peut survenir dans des circonstances particulières comme un diagnostic clinique particulier, des maladies concomitantes, des facteurs démographiques (le sexe, l'âge) ou des prédispositions particulières (des facteurs par exemple métaboliques ou immunologiques ou des réactions défavorables antérieures à un médicament ou à la classe de médicaments)."),
            TextEditorField::new('medic_dosage_max', 'Dosage maximum recommandé')
                ->setHelp("La dose maximale recommandé, est à titre informatif."),
            ...
            TextEditorField::new('fertily_pregnancy_breastfeeding', 'Fertilité, grossesse et allaitement')
                ->setHelp("Les résultats sur l'impact du médicament sur la grossesse, l'allaitement et la fertilité."),
            TextEditorField::new('medic_adverse_reaction', 'Effets indésirables')
