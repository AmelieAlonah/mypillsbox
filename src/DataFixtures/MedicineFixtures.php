    ...
    public function load(ObjectManager $manager)
    {
        for($index = 1; $index <= 15; $index++)
        {
            ...
            $medicine->setCodeCIS(60234100)
                     ...
                     ->setMedicCondition("<p>Traitement symptomatique des douleurs d'intensité légère à modérée et/ou des états fébriles. Traitement symptomatique des douleurs de l’arthrose. Cette présentation est réservée à l'adulte et à l’enfant à partir de 50 kg (soit à partir d’environ 15 ans).</p>")
                     ->setMedicDosage("<p>Attention : cette présentation contient 1000 mg de paracétamol par unité : ne pas prendre 2 unités à la fois. La posologie unitaire usuelle est de un comprimé à 1000 mg par prise, à renouveler au bout de 6 à 8 heures. En cas de besoin, la prise peut être répétée au bout de 4 heures minimum. Il n’est généralement pas nécessaire de dépasser 3 g de paracétamol par jour, soit 3 comprimés par jour. Cependant, en cas de douleurs plus intenses, la posologie maximale peut être augmentée jusqu’à 4 g par jour, soit 4 comprimés par jour. Toujours respecter un intervalle de 4 heures entre les prises</p>")
                     ->setMedicExeption("<p>La dose journalière efficace la plus faible doit être envisagée, sans excéder 60 mg/kg/jour (sans dépasser 3 g/j) dans les situations suivantes :
                     · poids < 50 kg,
                     · insuffisance hépatocellulaire légère à modérée,
                     · alcoolisme chronique,
                     · déshydratation,
                     · réserves basses en glutathion telles que par exemple malnutrition chronique, jeûne, amaigrissement récent, sujet âgé de plus de 75 ans ou de plus de 65 ans et polypathologique, hépatite virale chronique et VIH, mucoviscidose, cholémie familiale (maladie de Gilbert).</p>")
                     ->setMedicMethodAdministration("<p>Voie orale. Les comprimés sont à avaler tels quels avec une boisson (par exemple eau, lait, jus de fruits).</p>")
                     ->setMedicDanger("<p>· Hypersensibilité à la substance active ou à l’un des excipients.
                     · Insuffisance hépatocellulaire sévère.
                     · Enfant de moins de 6 ans en raison des risques de fausse route.</p>")
                     ->setMedicDosageMax("<p>Chez l’enfant de moins de 40 kg, la dose totale de paracétamol ne doit pas dépasser 80 mg/kg/jour.
                     Chez l’enfant de 41 à 50 kg, la dose totale de paracétamol ne doit pas excéder 3 g par jour.
                     Chez l’adulte et l’enfant de plus de 50 kg, LA DOSE TOTALE DE PARACETAMOL NE DOIT PAS EXCEDER 4 GRAMMES PAR JOUR</p>")
                     ->setMedicDosageMax40(0,80)
                     ->setMedicDosageMax50(3)
                     ->setMedicDosageMax50Plus(4)
                     ->setMedicInteractionOtherMedic("<p>+ Anticoagulants oraux : warfarine et autres antivitamines K (AVK); + Les résines chélatrices; + Flucloxacilline; + Médicaments hépatotoxiques</p>")
                     ->setFertilyPregnancyBreastfeeding("<p>Grossesse :
                     ...
                     Des effets sur la fertilité des mâles ont été observés dans une étude chez l'animal. La pertinence de ces effets chez l'homme n'est pas connue.</p>")
                     ->setMedicAdverseReaction("<p>Affections du système immunitaire :
                     ...
                     Fréquence indéterminée : bronchospasme</p>")
                     ->setIdCPD("1");
