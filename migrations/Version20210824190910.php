...
final class Version20210824190910 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE allergens_medicines (medicine_id INT NOT NULL, allergen_id INT NOT NULL, INDEX IDX_EC4D6E352F7D140A (medicine_id), INDEX IDX_EC4D6E356E775A4A (allergen_id), PRIMARY KEY(medicine_id, allergen_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE medicine_allergen (medicine_id INT NOT NULL, allergen_id INT NOT NULL, INDEX IDX_DFBDCEDA2F7D140A (medicine_id), INDEX IDX_DFBDCEDA6E775A4A (allergen_id), PRIMARY KEY(medicine_id, allergen_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
